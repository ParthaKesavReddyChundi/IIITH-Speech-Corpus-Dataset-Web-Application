...
export default async function RecordPage({ params }: RecordPageProps) {
  ...
  const nextSentenceResult = await supabase
    ...
    .single();
  const nextSentenceData = nextSentenceResult.data as { sentence_id: string; text: string; sentence_number: number; movie_name: string | null; intended_emotion: string | null } | null;
  const nextSentence = nextSentenceData ? { id: nextSentenceData.sentence_id, text: nextSentenceData.text, sentence_number: nextSentenceData.sentence_number, movie_name: nextSentenceData.movie_name, intended_emotion: nextSentenceData.intended_emotion } : null;
  return (
